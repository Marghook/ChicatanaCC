...
<head>
  <meta charset="UTF-8">
  <title>Creación de Invitado</title>
...
<body>
  <div class="container">
    ...
    <div class="contenido">
      ...
      <form class="formulario" method="post" action="agregar_invitado_admin.php">
        <h3>Creación de Invitado</h3>
        <label for="correo_socio">Correo del socio vinculado</label>
        <input type="email" id="correo" name="correo_socio" required>
